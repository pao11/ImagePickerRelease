...
import com.pao11.imagepicker.view.SystemBarTintManager;
...
public class ImageBaseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tintManager.setStatusBarTintResource(com.pao11.imagepicker.R.color.ip_color_primary_dark);  //设置上方状态栏的颜色
    }
