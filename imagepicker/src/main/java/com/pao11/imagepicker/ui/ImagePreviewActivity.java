...
import com.pao11.imagepicker.util.NavigationBarChangeListener;
...
public class ImagePreviewActivity extends ImagePreviewBaseActivity implements ImagePicker.OnImageSelectedListener, View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomBar = findViewById(com.pao11.imagepicker.R.id.bottom_bar);
        bottomBar.setVisibility(View.VISIBLE);

        mCbCheck = (SuperCheckBox) findViewById(com.pao11.imagepicker.R.id.cb_check);
        mCbOrigin = (SuperCheckBox) findViewById(com.pao11.imagepicker.R.id.cb_origin);
        marginView = findViewById(com.pao11.imagepicker.R.id.margin_bottom);
        mCbOrigin.setText(getString(com.pao11.imagepicker.R.string.ip_origin));
        ...
        mCbCheck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mCbCheck.isChecked() && selectedImages.size() >= selectLimit) {
                    Toast.makeText(ImagePreviewActivity.this, getString(com.pao11.imagepicker.R.string.ip_select_limit, selectLimit), Toast.LENGTH_SHORT).show();
    ...
    public void onImageSelected(int position, ImageItem item, boolean isAdd) {
        ...
        if (mCbOrigin.isChecked()) {
            ...
            mCbOrigin.setText(getString(com.pao11.imagepicker.R.string.ip_origin_size, fileSize));
        }
    }
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        if (id == com.pao11.imagepicker.R.id.cb_origin) {
            if (isChecked) {
                long size = 0;
    ...
    public void onImageSingleTap() {
        if (topBar.getVisibility() == View.VISIBLE) {
            topBar.setAnimation(AnimationUtils.loadAnimation(this, com.pao11.imagepicker.R.anim.top_out));
            bottomBar.setAnimation(AnimationUtils.loadAnimation(this, com.pao11.imagepicker.R.anim.fade_out));
...
//            if (Build.VERSION.SDK_INT >= 16) content.setSystemUiVisibility(View.SYSTEM_UI_FLAG_FULLSCREEN);
            ...
            topBar.setAnimation(AnimationUtils.loadAnimation(this, com.pao11.imagepicker.R.anim.top_in));
            bottomBar.setAnimation(AnimationUtils.loadAnimation(this, com.pao11.imagepicker.R.anim.fade_in));
            topBar.setVisibility(View.VISIBLE);
            bottomBar.setVisibility(View.VISIBLE);
            tintManager.setStatusBarTintResource(com.pao11.imagepicker.R.color.ip_color_primary_dark);//通知栏所需颜色
